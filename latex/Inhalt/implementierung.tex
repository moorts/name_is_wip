...
Im \ts{cpuStep()} wird der Code in \cref{lst:abcdefgichkanndasganzealphabet} ausgeführt.
...
\end{minted}
\caption{CP/M Syscall Emulation}
\label{lst:abcdefgichkanndasganzealphabet}
\end{listing}
