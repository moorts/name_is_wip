...
Die genaue Funktionsweise der Methode \rust{replace_names} aus Zeile 2 ist im Quellcode in \ref{lst:param-replace} näher beschrieben. Letztlich beläuft sie sich darauf, die Vorkommnisse der Schlüssel der angegebenen Map in einem String mit den entsprechenden Werten zu ersetzen.
