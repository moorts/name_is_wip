...
Wie jede CPU ist der Intel 8080 in der Lage Maschinensprache auszuführen. Diese stellt sogenannte Opcodes (Instruktionen) zur Verfügung. Dabei handelt es sich um jeweils 1 bis 3 Bytes, wobei das erste zur Identifikation der Instruktion gilt und die anderen Bytes ggf. Parameter enthalten.
