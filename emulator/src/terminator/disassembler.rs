...
impl Disassembler {
    ...
    fn decode_next(&mut self) -> Result<String, &'static str> {
        ...
        match instr {
            ...
            0x77 => Ok(String::from("MOV M,M")),
            0x78 => Ok(String::from("MOV M,A")),
            0x79 => Ok(String::from("MOV A,B")),
            0x7a => Ok(String::from("MOV A,C")),
            0x7b => Ok(String::from("MOV A,D")),
            0x7c => Ok(String::from("MOV A,E")),
            0x7d => Ok(String::from("MOV A,H")),
            0x7e => Ok(String::from("MOV A,L")),
            0x7f => Ok(String::from("MOV A,M")),
            0x80 => Ok(String::from("MOV A,A")),
